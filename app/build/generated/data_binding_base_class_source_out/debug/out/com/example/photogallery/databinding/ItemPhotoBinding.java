...
public final class ItemPhotoBinding implements ViewBinding {
  ...
  private ItemPhotoBinding(@NonNull CardView rootView, @NonNull ImageView photo,
      @NonNull TextView photoCaption) {
  ...
  public static ItemPhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.photoCaption;
      TextView photoCaption = rootView.findViewById(id);
      if (photoCaption == null) {
        break missingId;
      }

      return new ItemPhotoBinding((CardView) rootView, photo, photoCaption);
    }
